...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result_check) {
        ...
        if ($num > 0) {
            ...
            $sql_insert = "INSERT INTO `masrouf`(nom, prix, motif) VALUES('$nom', '$prix', '$motif')";
...
<body>
    ...
    <div class="container mt-5">
        <div class="dropdown">
            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton"
                ...
                <span class="input-group-text">Les Noms</span>

                <button type="submit" class="btn btn-success m-2" id="directione">Bénéficiaires</button>
            </button>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Motif</th>
                    <th>Prix</th>
                    <th>Total Prix</th> <!-- New column for total price -->
                </tr>
            </thead>
            <tbody>
                <?php
    ...
    document.getElementById("directione").addEventListener("click", function() {
        window.location.href = "print.php"; // Replace with your desired URL
    });
    </script>
